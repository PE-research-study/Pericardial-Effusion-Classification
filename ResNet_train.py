...
# This is the script used when training the ResNet model. When testing the PEAD framework,
...
import pandas as pd
import pathlib
from ResNet_model import resnet10, resnet34, resnet50, resnet101
...
weight_path = r'C:\Users\Haoyu Kong\Desktop\DL\ResNet\weight\PE-Res'
...
def main():
    ...
    for fold in range(1, fold_num+1):
        ...
        model = resnet10(num_classes=class_num)
        model.summary()
