...
def main():
    ...
    cardiac_data_root = os.path.join(project_root, "Data", "NMDID","NMDIDbaseline")  # caridac data set path
    # model_weight_path = os.path.join(os.getcwd(),"pretrain_weight", "vgg11-pre.pth")
