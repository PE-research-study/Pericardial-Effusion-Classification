...
def main():
    ...
    cardiac_data_root = os.path.join(project_root, "Data", "NMDID","PEdataset")  # caridac data set path
    model_weight_path = os.path.join(os.getcwd(),"pretrain_weight", "vgg19-pre.pth")
    ...
    for fold in range(0, nfold):
        ...
        train_cases = non_cases_list[:fold * (nfold - 1)] + non_cases_list[
                                                            (fold + 1) * (nfold - 1):]  # get all cases in train set
        ...
        net = vgg(model_name = "vgg19")
        # load pretrain weights
        # download url: https://download.pytorch.org/models/vgg19-dcbb9e9d.pth
